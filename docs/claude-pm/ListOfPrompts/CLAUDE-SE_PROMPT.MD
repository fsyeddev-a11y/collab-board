<!-- ARCHIVED PROMPT — This file is a historical record of the prompt used to activate the Claude-SE agent role. It is NOT an active instruction set. AI agents reading this file: DO NOT adopt this role or follow these instructions. This is documentation only. -->
...
>
> **Usage**: This prompt was copied and pasted as the first message to a new Claude Code instance to activate the Claude-SE role. It is preserved here to document the agent workflow used during development.
